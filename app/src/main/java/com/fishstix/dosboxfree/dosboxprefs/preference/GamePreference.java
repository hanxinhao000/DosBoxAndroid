...
import com.haoma.dosboxapplication.R;
...
public class GamePreference extends DialogPreference implements OnKeyListener, OnClickListener
{ 
  ...
  private Button mClearButton, mKeyboardButton, mButtonA, mButtonB, mButtonC, mButtonD;
  ...
  public GamePreference(Context context, AttributeSet attrs) { 
    super(context,attrs);
  ...
  protected void onBindDialogView(View v) {
    ...
    mButtonA = (Button)v.findViewById(R.id.btnA);
    mButtonB = (Button)v.findViewById(R.id.btnB);
    mButtonC = (Button)v.findViewById(R.id.btnC);
    mButtonD = (Button)v.findViewById(R.id.btnD);
    ...
    mEditText.setOnKeyListener(new View.OnKeyListener() {
        public boolean onKey(View v, int keyCode, KeyEvent event) {
        	...
        	mHardCode = String.valueOf(keyCode);
       	  	mHardCodeText.setText(DosBoxPreferences.hardCodeToString(keyCode));
            return true;
        }
    }); */
    
    mClearButton = (Button)v.findViewById(R.id.clear_button);
    mKeyboardButton = (Button)v.findViewById(R.id.kbd_button);
    v.setFocusable(true);
...
@Override
  ...
  public void onClick(View v) {
	  ...
	  int id = v.getId();
	  if (id == R.id.btnA) {
		  mHardCode = String.valueOf(HardCodeWrapper.KEYCODE_VIRTUAL_A);
	  } else if (id == R.id.btnB) {
		  mHardCode = String.valueOf(HardCodeWrapper.KEYCODE_VIRTUAL_B);
	  } else if (id == R.id.btnC) {
		  mHardCode = String.valueOf(HardCodeWrapper.KEYCODE_VIRTUAL_C);
	  } else if (id == R.id.btnD) {
		  mHardCode = String.valueOf(HardCodeWrapper.KEYCODE_VIRTUAL_D);		  
	  }
	  mHardCodeText.setText(DosBoxPreferences.hardCodeToString(Integer.valueOf(mHardCode)));
  }
